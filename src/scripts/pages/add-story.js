...
const AddPage = {
  render: async () => `
    <section aria-labelledby="add-title">
      <h2 id="add-title" class="section-title">Tambah Story</h2>
        ...
        <form id="addForm" enctype="multipart/form-data">
          ...
          <div class="camera-wrapper" style="margin-bottom:16px">
            ...
            <div style="display:flex;gap:8px;margin:8px 0">
              <button type="button" id="openCameraBtn" class="btn-pill">Buka Kamera</button>
              <button type="button" id="takePhotoBtn" class="btn-pill" style="display:none">Ambil Foto</button>
            </div>
          ...
          <div style="display:flex;gap:8px;margin-top:12px">
            ...
            <button type="button" id="cancelBtn" class="btn-pill" style="background:#fff;border:1px solid var(--border)">Batal</button>
      ...
      <div class="map-section" style="margin-top:16px">
        ...
        <div id="addMap" class="map-container" style="height:300px"></div>
      </div>
    </section>
  `,
  ...
  afterRender: async () => {
    ...
    const imgResult = document.getElementById("cameraResult");
